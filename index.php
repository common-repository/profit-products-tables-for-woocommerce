...
class WOOT {
    ...
    public function do_shortcode_button($args) {
       ...
       return WOOT_HELPER::draw_html_item('a', [
					'href' => "javascript: new Popup23({title: \""
					. esc_html($popup_title) . "\",help_title: \""
					. esc_html($help_title) . "\",help_link: \""
					. esc_html($help_link) . "\",post_id: -1, what: JSON.stringify({$args_json})}); void(0);",
